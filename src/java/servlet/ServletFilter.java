 ...
 * @author PC
 */
@WebFilter(filterName = "ServletFilter", urlPatterns = {"/recursoProtegido.html"})
public class ServletFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (session != null) {
            if (session.getAttribute("name") != null && session.getAttribute("name").equals(session.getAttribute("password"))) {
